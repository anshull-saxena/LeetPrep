...
;
const metadata = {
    title: 'Interview Prep | Company LeetCode Problems',
    description: 'Explore company-wise LeetCode problems to prepare for coding interviews. Filter by difficulty and time period.',
    generator: 'v0.app',
    icons: {
        icon: [
            {
